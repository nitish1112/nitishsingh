...
The hero background uses the supplied 3D UI motion reference, stored locally at `public/media/ui-motion-background.mp4` and presented with a custom color and readability treatment.
